...
GET_ALL_PROJECT_BEGIN , GET_ALL_PROJECT_SUCCESS , GET_REQUESTS_BEGIN ,  GET_REQUESTS_SUCCESS , UPDATE_REQUEST_BEGIN  } from "./action";
...
const AppProvider = ({children}) => {
    ...
    const getRequests = async () => {
      ...
      try {
        ...
        const {request} = data
        dispatch ({type: GET_REQUESTS_SUCCESS , 
          payload:{
            request
          }
          })
